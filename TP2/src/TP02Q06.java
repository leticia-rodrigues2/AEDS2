...
public class TP02Q06 {
	    ...
	    public static void main(String args[]) throws IOException, ParseException{
	        ...
	        tempo.start();
	        Relatorio relatorio = QuickSort.sort(vetorMusicas);
	        tempo.stop();
	...
	class QuickSort {
	    ...
	    public static Relatorio sort(Musica [] vetor) {
	        ...
	        QuickSort.quickSort(vetor, 0, vetor.length-1, relatorio);
	        return relatorio;
	    }
	    private static void quickSort(Musica[] vetor, int inicio, int fim, Relatorio relatorio) {
	        if (inicio < fim) {
	            int posicaoPivo = separar(vetor, inicio, fim, relatorio);
	            quickSort(vetor, inicio, posicaoPivo - 1, relatorio);
	            quickSort(vetor, posicaoPivo + 1, fim, relatorio);
	        }
	    }

	    private static int separar(Musica[] vetor, int inicio, int fim, Relatorio relatorio) {
